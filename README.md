...
After cloning the repos ([moedict-data.git](https://github.com/g0v/moedict-data.git), [moedict-epub.git](https://github.com/g0v/moedict-epub.git)),  you get `moedict-data/dict-revised.json`.
